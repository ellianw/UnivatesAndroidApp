        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (missingField(findViewById(R.id.root))) {
                    Toast.makeText(DataEntryActivity.this, "Por favor, preencha todos os campos!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                builder.setMessage(Html.fromHtml("Confirme seus dados: <br>"+"<b>"+"Nome: "+"</b>"+name+
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(DataEntryActivity.this, "Obrigado por informar seus dados!", Toast.LENGTH_SHORT).show();
